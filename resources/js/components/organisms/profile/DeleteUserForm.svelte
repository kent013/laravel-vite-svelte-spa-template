<script lang="ts">
  ...
  import DangerButton from '~/components/atoms/DangerButton.svelte'
  ...
  <Modal show={confirmingUserDeletion} onClose={closeModal}>
    <div class="p-6">
      ...
      <div class="mt-6 flex justify-end">
        ...
        <DangerButton disabled={$form.processing} onClick={deleteUser} classes="ml-3">Delete Account</DangerButton>
      </div>
    </div>
  </Modal>
</section>
